    ...
    <main class="mt-md-3 mt-lg-5">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-3 col-md-6 offset-lg-1 text-end">
                    <button type="submit" form="product_form" class="btn btn-success me-2">Save</button>
                ...
                <div class="col-md-5 offset-lg-1">
                    ...
                    <form action="" id="product_form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select form-select-sm" id="productType" aria-label="product type">
                                <option disabled="" selected="" value="12">Open this select menu</option>
                        ...
                        <div class="product-type_inputs">
                            <div class="form-group d-none" id="dvd">
                                ...
                                <input type="number" name="size" id="size" class="form-control form-control-sm">
                            ...
                            <div class="form-group d-none" id="furniture">
                                <div class="mb-3">
                                    ...
                                    <input type="number" id="height" name="height" class="form-control form-control-sm" />
                                </div>
                                <div class="mb-3">
                                    <label for="width" class="form-label fs-4">Width (CM) </label>
                                    <input type="number" id="width" name="width" class="form-control form-control-sm" />
                                </div>
                                <div class="mb-3">
                                    <label for="length" class="form-label fs-4">Length (CM) </label>
                                    <input type="number" id="length" name="length" class="form-control form-control-sm" />
                                </div>
